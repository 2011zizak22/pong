...
def randomize_start():
    ...
    y = random.randunt(10, display_height - 10)
...
def game_over():
    ...
    rinstructions = font_instructions_render("Press r to Resume", 255, 255, 255)
...
while True:
    ...
    if pressed_key[pygame.K_DOWN] or [pygame.K_s]:
        if paddle_y + paddle_height + 10 <= display_height:
            paddle_y += 10
    if pressed_key[pygame.K_UP] or [pygame.K_w]:
        if paddle_y - 10 >= 0:
            paddle_y -= 10
